...
// input files train.txt and test.txt. 
...
const char *faceCascadeFilename = "c:\\opencv2.1\\data\\haarcascades\\haarcascade_frontalface_alt.xml";
...
int faceWidth = 50;	// Default dimensions for faces in the face recognition database. Added by Shervin.
int faceHeight = 50;	//	"		"		"		"		"		"		"		"
